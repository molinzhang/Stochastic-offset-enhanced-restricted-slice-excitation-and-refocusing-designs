...
from mrphy_refoc import T1G, T2G, γH, dt0, π
...
class BlochSim(Function):
    ...
    def forward(
        ...
        #sio.savemat('/home/molin/shimm_nick/decompose_refocus/demo/ISMRM/compare/refocus_test/selective/excitation/spin/pulse18/' + str(random.random()) + 'Mo1.mat', {'Mo':MO})
        return Mo

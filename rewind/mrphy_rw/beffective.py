...
from mrphy_rw import γH, dt0, π
from mrphy_rw import utils
...
def rfgr2beff(
    ...
    #coil_loop = sio.loadmat("/home/molin/shimm_nick/op_rewind/fields_z.mat")
    #mat_content = coil_loop['fields'] #* 0.0023 # 64, 64, 64, 35_4mm
    ...
    if type(offset_loc_) == type(None):
        ...
        fc = intp[mask == True]
        offset_loc_ = offset_loc_[mask == True] * 0.401#0.401 ## only apply to the gradient mag
    ...
    #sio.savemat('/home/molin/shimm_nick/decompose_refocus/demo/ISMRM/compare/refocus_test/Check_nosense/doubtcheck/Bx2.mat', {'Bz':BX})

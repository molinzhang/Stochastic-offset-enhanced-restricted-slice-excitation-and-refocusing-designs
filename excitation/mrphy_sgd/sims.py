...
from mrphy_sgd import T1G, T2G, γH, dt0, π
...
class BlochSim(Function):
    ...
    def forward(
        ...
        #sio.savemat('/home/molin/shimm_nick/decompose_refocus/demo/ISMRM/compare/refocus_test/sagittal/' + 'pulse9traj' + 'Mo1.mat', {'Mo':np.squeeze(MO)})
        return Mo
